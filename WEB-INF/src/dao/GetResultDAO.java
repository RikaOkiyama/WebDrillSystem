...
public class GetResultDAO extends DriverAccessor{
	...
	public ArrayList GetList2(String id,String userId,Connection connection){

		try{
			
			
			String sql="select * from result  left join question on result.questionId = question.id where id= ? and result.userId=?";
